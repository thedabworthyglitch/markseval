...
def display_result():
    ...
    if (sub1 == "" and sub2 == "" and sub3 == "" and sub4 == "" and sub5 == ""):
        ...
        if val == -1:
            ...
            if (
                    marks1 >= 0 and marks1 <= 100 and marks2 >= 0 and marks2 <= 100 and marks3 >= 0 and marks3 <= 100 and marks4 >= 0 and marks4 <= 100 and marks5 >= 0 and marks5 <= 100):
...
if __name__ == "__main__":
    ...
    gui_root.title("Student Marks Evaluator")
    ...
    marks_label = Label(subject_frame, text="Marks Obtained", font=("Times New Roman", "11", "bold"), bg="#FCEEF6",
                        fg="#5C153E")
    marks_extra_label = Label(subject_frame, text="(Out of 100)", font=("Times New Roman", "11", "bold"), bg="#FCEEF6",
                              fg="#5C153E")
